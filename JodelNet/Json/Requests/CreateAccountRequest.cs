...
namespace JodelNet.Json.Requests
{
    public class CreateAccountRequest : JodelRequestBase, IJodelRequest<CreateAccountResponse>
    {
        ...
        public CreateAccountRequest(JodelUser user, HttpMethod method, string url, string version = "v2", string postData = "", bool authorize = true) : base(user, method, url, version, postData, authorize)
        {
        }
    }
}

...
{
    public class FollowChannelRequest : JodelRequestBase, IJodelRequest<bool>
    {
        public FollowChannelRequest(JodelUser user, HttpMethod method, string url, string version = "v2", string postData = "", bool authorize = true) : base(user, method, url, version, postData, authorize)
        {
        }
